...
class ReFile(tk.Frame):
    ...
    def configureGUI(self):
        ...
        self.dataLabel = ttk.Label(
            self.dataFrame, text='Data', style='Tab.TLabel')
        ...
        self.checkBoxLabel = ttk.Label(
            self.checkBoxFrame, text='Columns', style='Tab.TLabel')
    ...
    def createWidgets(self):
        ...
        self.dataFieldLabel.pack(padx=5, pady=(
            0, 5), fill=tk.BOTH, expand=True)
    ...
    def displayFiles(self):
        ...
        for xlFile in self.xlFiles:
            ...
            imageCanvas.create_image(
                (0, 0), anchor=tk.N+tk.W, image=self.xlsIcon)
